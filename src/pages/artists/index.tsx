      ...
      <div className="w-4/5">
        {artists.map((a) => (
          <Link href={`/artists/${a.id}`} key={a.id}>
            <div className="border-2 border-accent rounded-lg w-full my-5 flex flex-col sm:flex-row justify-between hover:scale-105 transition-transform duration-300 ease-in-out">
